...
class ChatOutputSchema(BaseModel):
    summary: str = Field(
        description="A direct, plain-spoken 1-2 sentence response. NEVER use meta-commentary like 'I can help you by combining...', 'Based on your reflections...', or 'By synthesizing your notes...'. Jump straight to the substance."
    )
